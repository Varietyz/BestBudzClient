    ...
    while (flag19) {
      ...
      for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4; )
        if (k5 == 0 || k5 == 1) {
          ...
          j6++;
          byte byte5 =
              class32.aByteArray591[class32.aByteArray592[class32.anIntArray593[0]] & 0xff];
          ...
          if (j11 < 16) {
            ...
            for (; l10 > 0; l10--) {
              ...
              class32.aByteArray592[class32.anIntArray593[l10]] =
                  class32.aByteArray592[(class32.anIntArray593[l10 - 1] + 16) - 1];
            }
      ...
      System.arraycopy(class32.anIntArray583, 0, class32.anIntArray585, 1, 256);
