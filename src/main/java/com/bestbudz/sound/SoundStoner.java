...
public class SoundStoner implements Runnable {
	...
	private Thread stoner;
	private int delay;
	private int soundLevel;
	public static int volume;

	/**
	 * Initializes the sound stoner.
	 * 
	 * @param stream
	 * @param level
	 * @param delay
	 */
	public SoundStoner(InputStream stream, int level, int delay) {
