...
public class Model extends Animable {
	...
	public static void nullLoader() {
		...
		aOnDemandFetcherParent_1662 = null;
		modelIntArray1 = null;
		modelIntArray2 = null;
		modelIntArray3 = null;
		modelIntArray4 = null;
		...
		if (anIntArray1640 != null) {
			for (int triangle = 0; triangle < anInt1630; triangle++) {
				if (triangle < anIntArray1640.length) {
					if (anIntArray1640[triangle] == 37798) {
		...
		for (int k14 = 0; k14 < numTexTriangles; k14++) {
			...
			if (i15 == 1) {
				...
				if (newformat < 15) {
					...
					if (newformat == 14)
						Objects.requireNonNull(N)[k14] = nc3.v(-1);
					else
						Objects.requireNonNull(N)[k14] = nc3.readUnsignedWord();
					Objects.requireNonNull(y)[k14] = nc3.readUnsignedWord();
				} else {
					Objects.requireNonNull(kb)[k14] = nc3.v(-1);
					Objects.requireNonNull(N)[k14] = nc3.v(-1);
					Objects.requireNonNull(y)[k14] = nc3.v(-1);
				}
	...
	public void method464(Model model, boolean flag) {
		...
		ws.ensureCapacity(model.anInt1626, model.anInt1630);

		anInt1626 = model.anInt1626;
		anInt1630 = model.anInt1630;
		anInt1642 = model.anInt1642;

		anIntArray1627 = ws.tempVertexBuffer;
		anIntArray1628 = new int[anInt1626];
		anIntArray1629 = new int[anInt1626];
		...
		if (flag) {
			...
			anIntArray1639 = ws.tempAlphaBuffer;
			if (model.anIntArray1639 == null) {
				java.util.Arrays.fill(anIntArray1639, 0, anInt1630, 0);
			} else {
				System.arraycopy(model.anIntArray1639, 0, anIntArray1639, 0, anInt1630);
			}
		}
	...
	private void processCurrentFrameOnly(SequenceFrame currAnim, Class18 skinList) {
		...
		for (int i = 0; i < frameCount; i++) {
			...
			method472(opcodes[animIndex], transformations[animIndex], frameX[i], frameY[i], frameZ[i]);
		}
	}

	private void processInterpolatedFrames(SequenceFrame currAnim, SequenceFrame nextAnim, Class18 skinList, int cycle, int length) {
	...
	public final void applyLighting(int i, int j, int k, int l, int i1, boolean flag) {
		...
		for (int i2 = 0; i2 < anInt1630; i2++) {
			...
			if (anIntArray1637 == null || (anIntArray1637[i2] & 1) == 0) {
				...
				anIntArray1634[i2] = method481(Objects.requireNonNull(anIntArray1640)[i2], l5, anIntArray1637[i2]);
			}
		}
		...
		for (int k = 0; k < anInt1630; k++)
			if (anIntArray1637 == null || anIntArray1637[k] != -1) {
				...
				if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					int j5 = (ws.anIntArray1667[l] + ws.anIntArray1667[k1] + ws.anIntArray1667[j2]) / 3 + anInt1653;
					ws.anIntArrayArray1672[j5][ws.anIntArray1671[j5]++] = k;
				} else {
					if (flag1 && method486(anInt1685, anInt1686, ws.anIntArray1666[l], ws.anIntArray1666[k1], ws.anIntArray1666[j2], i3, l3, k4)) {
					...
					if ((i3 - l3) * (ws.anIntArray1666[j2] - ws.anIntArray1666[k1]) - (ws.anIntArray1666[l] - ws.anIntArray1666[k1]) * (k4 - l3) > 0) {
						...
						int k5 = (ws.anIntArray1667[l] + ws.anIntArray1667[k1] + ws.anIntArray1667[j2]) / 3 + anInt1653;
						ws.anIntArrayArray1672[k5][ws.anIntArray1671[k5]++] = k;
					}
				}
			}
	...
	private void method485(int i) {
		...
		if (l1 >= 50) {
			...
			ws.anIntArray1680[l++] = anIntArray1634[i];
		} else {
			...
			if (j2 >= 50) {
				...
				ws.anIntArray1680[l++] = k4 + ((anIntArray1636[i] - k4) * k5 >> 16);
			}
			if (i2 >= 50) {
				...
				ws.anIntArray1680[l++] = k4 + ((anIntArray1635[i] - k4) * l5 >> 16);
			}
		}
		if (i2 >= 50) {
			ws.anIntArray1678[l] = ws.anIntArray1665[j1];
			ws.anIntArray1679[l] = ws.anIntArray1666[j1];
			ws.anIntArray1680[l++] = anIntArray1635[i];
		} else {
			...
			if (l1 >= 50) {
				...
				ws.anIntArray1680[l++] = l4 + ((anIntArray1634[i] - l4) * i6 >> 16);
			}
			if (j2 >= 50) {
				...
				ws.anIntArray1680[l++] = l4 + ((anIntArray1636[i] - l4) * j6 >> 16);
			}
		}
		if (j2 >= 50) {
			ws.anIntArray1678[l] = ws.anIntArray1665[k1];
			ws.anIntArray1679[l] = ws.anIntArray1666[k1];
			ws.anIntArray1680[l++] = anIntArray1636[i];
		} else {
			...
			if (i2 >= 50) {
				...
				ws.anIntArray1680[l++] = i5 + ((anIntArray1635[i] - i5) * k6 >> 16);
			}
			if (l1 >= 50) {
				...
				ws.anIntArray1680[l++] = i5 + ((anIntArray1634[i] - i5) * l6 >> 16);
			}
		}
