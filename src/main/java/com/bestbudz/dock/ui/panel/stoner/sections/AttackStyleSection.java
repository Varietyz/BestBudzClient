...
public class AttackStyleSection
{
	...
	public JPanel createPanel(int width) {
		...
		panel.setPreferredSize(new Dimension(width - 16, 85));
		panel.setMaximumSize(new Dimension(width - 16, 85));

		JLabel titleLabel = new JLabel("Attack Style");
	...
	public void updateData() {
		...
		contentLabel.setText("Attack styles coming soon!");
	}
}