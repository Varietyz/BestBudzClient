...
public class PetsSection
{
	...
	public JPanel createPanel(int width) {
		...
		panel.setPreferredSize(new Dimension(width - 16, 90));
		panel.setMaximumSize(new Dimension(width - 16, 90));

		JLabel titleLabel = new JLabel("Pets");
	...
	public void updateData() {
		...
		contentLabel.setText("Pets overview coming soon!");
	}
}