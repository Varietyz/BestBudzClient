...
public class SpellbookSection
{
	...
	public JPanel createPanel(int width) {
		...
		panel.setPreferredSize(new Dimension(width - 16, 120));
		panel.setMaximumSize(new Dimension(width - 16, 120));

		JLabel titleLabel = new JLabel("Spellbook");
	...
	public void updateData() {
		...
		contentLabel.setText("Spellbook handling coming soon!");
	}
}