...
public final class Rasterizer extends DrawingArea
{
	...
	public static int[][] method371(int textureId) {
	...
	public static void method374(int y1, int y2, int y3, int x1, int x2, int x3,
		...
		if (GPURenderingEngine.isEnabled()) {
			...
			GPUShaders.renderTriangle(x1, y1, x2, y2, x3, y3, hsl1, hsl2, hsl3, z1, z2, z3);
		} else {
			// 💻 CPU FALLBACK: Use existing CPU code
			method374CPU(y1, y2, y3, x1, x2, x3, hsl1, hsl2, hsl3, z1, z2, z3);
		}
	}

	public static void method374CPU(int y1, int y2, int y3, int x1, int x2, int x3, int hsl1, int hsl2, int hsl3, float z1,
			float z2, float z3) {
	...
	public static void method378(int y_a, int y_b, int y_c, int x_a, int x_b, int x_c, int l1, int l2, int l3, int tx1,
		...
		if (isMainGame && GPURenderingEngine.isEnabled()) {
			...
			GPUShaders.renderTexturedTriangle(y_a, y_b, y_c, x_a, x_b, x_c, l1, l2, l3, tx1, tx2, tx3, ty1, ty2, ty3, tz1, tz2, tz3, tex, z1, z2,z3);
		} else {
			// 💻 CPU FALLBACK
			method378CPU(y_a, y_b, y_c, x_a, x_b, x_c, l1, l2, l3, tx1, tx2, tx3, ty1, ty2, ty3, tz1, tz2, tz3, tex, z1, z2,z3);
		}
	}

	public static void method378CPU(int y_a, int y_b, int y_c, int x_a, int x_b, int x_c, int l1, int l2, int l3, int tx1,
			int tx2, int tx3, int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex, float z1, float z2,
			float z3) {
		try {
			if (!aBoolean1464) {
