...
public class OptionsTab extends RSInterface {
  ...
  public static void optionTab(TextDrawingArea[] bestbudz) {
    ...
    addSprite(947, 102);
    addSprite(949, 103);
    addHoverButton(36004, 0, 54, 43, "WEIRD PEOPLE", -1, 36005, 1);
    addHoveredButton(36005, 1, 54, 43, 36006);
    addHoverButton(36007, 2, 54, 43, "NORMAL PEOPLE", -1, 36008, 1);
    addHoveredButton(36008, 3, 54, 43, 36009);
    addHoverButton(36010, 4, 54, 43, "BLIND PEOPLE", -1, 36011, 1);
    ...
    addText(36013, "weird..", bestbudz, 0, 0xff9933, true, true);
    addText(36014, "Normal", bestbudz, 0, 0xff9933, true, true);
    addText(36015, "BLIND", bestbudz, 0, 0xff9933, true, true);
