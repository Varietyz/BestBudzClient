...
public class CustomInterfaces extends RSInterface {
	...
	public static void unpackInterfaces(TextDrawingArea[] BestBudz) {
		 ...
		 */
		equipmentTab(BestBudz);
		equipmentScreen(BestBudz);

		/*
		 * Quick necromance & curses
		 */
		quickCurses(BestBudz);
		quickPrayers(BestBudz);
		...
		/*
		 * Handles teleporting to various locations around BestBudz
		 */
		...
		/*
		 * Handles the CannaCredits system for BestBudz
		 */
		creditsTab(BestBudz);

		/*
		 * Handles showing stoner what items will be kept and lost on death
		 */
		 ...
		 */
		/*
		 * Handles reseting a stoner's statistic
		 */
		genie(BestBudz);

		/*
		 * Handles the random event - Misery Box
		 */
		mysteryBox(BestBudz);
		...
		/*
		 * Handles Stoner Profiler interface
		 */
		...
		/*
		 * Shows list of tracked statistics for a stoner
		 */
		tracker(BestBudz);
	...
	// public static void screenOptions(TextDrawingArea[] bestbudz) {
	// RSInterface tab = addInterface(28200);
	// addSprite(28201, 472);
	// addText(28202, "Screen Options", bestbudz, 2, 0xff9933, true, true);
	...
	// addText(28209, "Transparent side panel", bestbudz, 1, 0xff9933, false, true);
	// addText(28210, "Make each side panel transparent", bestbudz, 0, 0xff9933,
	// false, true);
	// addText(28211, "Transparent chatbox", bestbudz, 1, 0xff9933, false, true);
	// addText(28212, "Make chatbox transparent", bestbudz, 0, 0xff9933, false,
	// true);
	// addText(28213, "Side-stones arrangement", bestbudz, 1, 0xff9933, false,
	// true);
	// addText(28214, "Change the side-stones arrangement", bestbudz, 0, 0xff9933,
	// false, true);
	// addText(28215, "Settings are not applicable in fixed mode!", bestbudz, 0,
	// 0xff9933, true, true);
	...
	public static void inSafe(TextDrawingArea[] jaybane) {
	...
	public static void PKSkillTab(TextDrawingArea[] jaybane) {
		...
		for (int i = 0; i < 8; i++) {
			addText(63720 + i, "@or2@99/99", 0x000000, false, true, 52, jaybane, 1);
		}
	...
	public static void profileTab(TextDrawingArea[] jaybane) {
		...
		addHoverText(51509, "Hide in the bushes", "Hide in bush", jaybane, 0, 0xF7AA25, false, true, 60);
		addHoverText(51510, "Be prominent", "Stoners can see you", jaybane, 0, 0xF7AA25, false, true, 60);
	...
	public static void myProfile(TextDrawingArea[] jaybane) {
		...
		for (int i = 0; i < 20; i++) {
			...
			addTooltipBox(51632 + i, Skills.SKILL_NAMES[i].substring(0, 1).toUpperCase()
					+ Skills.SKILL_NAMES[i].substring(1) + " grade: 1/1\\nAdvance grade: 1");
	...
	public static void advance(TextDrawingArea[] jaybane) {
		...
		// addHoverButton(51095, "", 0, 104, 30, "", 0, 51096, 1);
	...
	public static void chatColor(TextDrawingArea[] jaybane) {
		...
		addText(37505, "Private Chat Color Changer", 0xff9933, true, true, -1, jaybane, 3);
		addText(37506, "Chosen color: ", 0xff9933, true, true, -1, jaybane, 1);
	...
	public static void mysteryBox(TextDrawingArea[] jaybane) {
		...
		// addHoverText(17011, "Purchase more CannaCredits", "Purchase bestbudz
		// CannaCredits",
		// jaybane, 0, 0xF7AA25, false, true, 168);
		...
		rsinterface.child(10, 17011, 800, 800); // framebox hidden USELESS ( DO NOT DELETE )
	...
	public static void genie(TextDrawingArea[] jaybane) {
		...
		addHoverButton(59506, "", 0, 130, 30, "Reset Assault", 0, 59507, 1);
		addHoveredButton(59507, 250, 130, 30, 59508);
		addHoverButton(59509, "", 0, 130, 30, "Reset Vigour", 0, 59510, 1);
		addHoveredButton(59510, 251, 130, 30, 59511);
		addHoverButton(59512, "", 0, 130, 30, "Reset Aegis", 0, 59513, 1);
		...
		addHoverButton(59518, "", 0, 130, 30, "Reset Mage", 0, 59519, 1);
		addHoveredButton(59519, 254, 130, 30, 59520);
		addHoverButton(59521, "", 0, 130, 30, "Reset Necromance", 0, 59522, 1);
		addHoveredButton(59522, 255, 130, 30, 59523);
		addHoverButton(59524, "", 0, 130, 30, "Reset Life", 0, 59525, 1);
	 ...
	 * @param jaybane
	 * 
	 *                public static void barrows(TextDrawingArea[] jaybane) {
	 *                RSInterface tab = addInterface(59000);
	 *                addTransparentSprite(59001, 248);
	 *                addText(59002, "Barrows Brothers", 0xff9933, true, true, -1,
	 *                jaybane, 2);
	 *                addText(59003, "Ahrim the Blighted", 0xff9933, true, true, -1,
	 *                jaybane, 1);
	 *                addText(59004, "Dharok the Wretched", 0xff9933, true, true,
	 *                -1, jaybane, 1);
	 *                addText(59005, "Guthan the Infested", 0xff9933, true, true,
	 *                -1, jaybane, 1);
	 *                addText(59006, "Karil the Tainted", 0xff9933, true, true, -1,
	 *                jaybane, 1);
	 *                addText(59007, "Torag the Corrupted", 0xff9933, true, true,
	 *                -1, jaybane, 1);
	 *                addText(59008, "Verac the Defiled", 0xff9933, true, true, -1,
	 *                jaybane, 1);
	 *                tab.totalChildren(8);
	 ...
	 * @param bestbudz
	 */
	private static void shop(TextDrawingArea[] bestbudz) {
	...
	public static void trainingTeleport(TextDrawingArea[] bestbudz) {
		...
		addText(61023, "@bla@Teleportation Menu (@red@Training@bla@)", 0x20CF2F, true, true, -1, bestbudz, 2);
	...
	public static void skillingTeleport(TextDrawingArea[] bestbudz) {
		...
		addText(62023, "@bla@Teleportation Menu (@red@Skilling@bla@)", 0x20CF2F, true, true, -1, bestbudz, 2);
	...
	public static void pvpTeleport(TextDrawingArea[] bestbudz) {
		...
		addText(63023, "@bla@Teleportation Menu (@red@Stoner Vs Stoner@bla@)", 0x20CF2F, true, true, -1, bestbudz, 2);
	...
	public static void bossTeleport(TextDrawingArea[] bestbudz) {
		...
		addText(64023, "@bla@Teleportation Menu (@red@Stoner Vs Monster@bla@)", 0x20CF2F, true, true, -1, bestbudz, 2);
	...
	public static void minigameTeleport(TextDrawingArea[] bestbudz) {
		...
		addText(65023, "@bla@Teleportation Menu (@red@Minigame@bla@)", 0x20CF2F, true, true, -1, bestbudz, 2);
	...
	public static void otherTeleport(TextDrawingArea[] bestbudz) {
		...
		addText(61523, "@bla@Teleportation Menu (@red@Other@bla@)", 0x20CF2F, true, true, -1, bestbudz, 2);
	...
	public static void optionTab(TextDrawingArea[] bestbudz) {
		...
		addText(36003, "Options Tab", bestbudz, 1, 0xff9933, true, true);
		addText(36013, "Fixed", bestbudz, 0, 0xff9933, true, true);
		addText(36014, "Resizable", bestbudz, 0, 0xff9933, true, true);
		addText(36015, "Fullscreen", bestbudz, 0, 0xff9933, true, true);
		addHoverText(36025, "Screen Options", "Screen Options", bestbudz, 0, 0xff981f, true, true, 60);
	 ...
	 * @param bestbudz
	 */
	public static void quickPrayers(TextDrawingArea[] bestbudz) {
		int frame = 0;
	...
	public static void quickCurses(TextDrawingArea[] bestbudz) {
		...
		for (int i = 17202, j = 630; i <= 17228 || j <= 656; i++, j++) {
			...
			// addConfigButton(j, 17200, 2, 1, "QuickPrayer/Sprite", 14, 15, "Select",
			// 0, 1,
			// k);
	 ...
	 * @param bestbudz
	 */
	public static void equipmentTab(TextDrawingArea[] bestbudz) {
